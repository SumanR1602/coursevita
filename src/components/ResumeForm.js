...
const handleButtonClick = () => {
  ...
  return (
    <form className="bg-white p-6 rounded-lg space-y-4">
        ...
        {formData.education.map((edu, index) => (
          <div key={index} className="space-y-2">
            <input
              type="text"
              value={edu.clg_name}
              onChange={(e) => handleSectionChange("education", index, "clg_name", e.target.value)}
            ...
            <input
              ...
              onChange={(e) => handleSectionChange("education", index, "course_name", e.target.value)}
              placeholder="Course"
              className="w-full p-2 border rounded"
            />
            <input
              type="text"
              value={edu.cgpa}
              onChange={(e) => handleSectionChange("education", index, "cgpa", e.target.value)}
              placeholder="CGPA"
              className="w-full p-2 border rounded"
            />
            <input
              type="text"
              value={edu.from}
              onChange={(e) => handleSectionChange("education", index, "from", e.target.value)}
              placeholder="From"
              className="w-full p-2 border rounded"
            />
            <input
              type="text"
              value={edu.to}
              onChange={(e) => handleSectionChange("education", index, "to", e.target.value)}
              placeholder="To"
              className="w-full p-2 border rounded"
            />
        ...
        {formData.experience.map((experience, index) => (
          <div key={index} className="mb-4 border-b pb-4">
            <input
              ...
              onChange={(e) => handleSectionChange("experience", index, "exp_position", e.target.value)}
            ...
            <input
              ...
              onChange={(e) => handleSectionChange("experience", index, "exp_company",  e.target.value)}
              className="w-full mb-2 p-2 border border-gray-300 rounded-md shadow-sm"
            />
            <textarea
              name="description"
              ...
              onChange={(e) => handleSectionChange("experience", index, "exp_desc",  e.target.value)}
              rows="2"
            ...
            <div className="flex gap-2">
              <input
                ...
                placeholder="From"
                onChange={(e) => handleSectionChange("experience", index, "exp_from",  e.target.value)}
              ...
              <input
                ...
                placeholder="To"
                onChange={(e) => handleSectionChange("experience", index, "exp_to",  e.target.value)}
                className="w-1/2 mb-2 p-2 border border-gray-300 rounded-md shadow-sm"
              />
            </div>
        ...
        {formData.certifications.map((certifications, index) => (
          <div key={index} className="mb-4 border-b pb-4">
            <input
              ...
              onChange={(e) => handleSectionChange("certifications", index, "cert_name", e.target.value)}
              className="w-full mb-2 p-2 border border-gray-300 rounded-md shadow-sm"
            />
            <input
              type="text"
              ...
              placeholder="Organization"
              onChange={(e) => handleSectionChange("certifications", index, "cert_orgname",  e.target.value)}
              className="w-full mb-2 p-2 border border-gray-300 rounded-md shadow-sm"
            />
            <textarea
              name="cert_link"
              ...
              placeholder="Links"
              onChange={(e) => handleSectionChange("certifications", index, "cert_link",  e.target.value)}
              rows="2"
              className="w-full p-2 border border-gray-300 rounded-md shadow-sm"
            />
        ...
        {formData.projects.map((project, index) => (
          <div key={index} className="mb-4 border-b pb-4">
            <input
              ...
              onChange={(e) => handleSectionChange("projects", index, "proj_name", e.target.value)}
              className="w-full mb-2 p-2 border border-gray-300 rounded-md shadow-sm"
            />
            <textarea
              name="proj_desc"
              ...
              placeholder="Desc"
              onChange={(e) => handleSectionChange("projects", index, "proj_desc",  e.target.value)}
              rows="3"
              className="w-full p-2 border border-gray-300 rounded-md shadow-sm"
            />
            <input
              ...
              onChange={(e) => handleSectionChange("projects", index, "proj_link", e.target.value)}
              className="w-full mb-2 p-2 border border-gray-300 rounded-md shadow-sm"
            />
